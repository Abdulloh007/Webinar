            ...
            <div class="s-row s-jc-sb">
                <div class="s-product__filter">
                    ...
                    <div class="s-pf__list">
                        ...
                        <div class="s-pfl__item s-dfw s-jc-sb s-alt-center">
                            <div class="s-cotegory__list">
                                <p class="s-cl__item">Молоко</p>
                                <p class="s-cl__item">Сливки</p>
                                <p class="s-cl__item">Яйцо</p>
                            </div>
                        </div>
                    </div>
                    <button class="s-btn s-btn__orange">Применить</button>
                </div>
